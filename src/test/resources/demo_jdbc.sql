...
--------------------------------------------------------
  ...
  CREATE TABLE "LAPR3_2019_G022"."SAILORS"
   (	"SID" NUMBER,
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "LAPR3_2019_G022"."SAILORS_PK" ON "LAPR3_G50"."SAILORS" ("SID")
...
--------------------------------------------------------
  ...
  ALTER TABLE "LAPR3_2019_G022"."SAILORS" ADD CONSTRAINT "SAILORS_PK" PRIMARY KEY ("SID")
