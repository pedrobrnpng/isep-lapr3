...
public class GraphTest {
    ...
    public void testAdjVertices() {
        ...
        instance.insertVertex("A");
        instance.insertVertex("B");
        assertTrue(instance.adjVertices("C") == null);
    }
    ...
    public void testEndVertices() {
        ...
        instance.insertEdge("E", "D", "Edge7", 1);
        instance.insertEdge("E", "E", "Edge8", 1);
        instance.insertEdge("G", null, "Edge9", 1);
        instance.insertEdge("A", null, "Edge10", 1);
        instance.insertEdge(null, "F", "Edge11", 1);
        instance.insertEdge(null, "A", "Edge12", 1);
        ...
        Edge<String, String> edge2 = instance.getEdge("A", null);
        vertices = instance.endVertices(edge2);
        assertTrue(vertices[0].equals("A") && vertices[1]==null);
        
        Edge<String, String> edge3 = instance.getEdge("G", null);
        vertices = instance.endVertices(edge3);
        assertTrue(vertices[0].equals("G") && vertices[1]==null);
        
        Edge<String, String> edge4 = instance.getEdge(null, "F");
        vertices = instance.endVertices(edge4);
        assertTrue(vertices[0]==null && vertices[1].equals("F"));
        
        Edge<String, String> edge5 = instance.getEdge(null, "A");
        vertices = instance.endVertices(edge5);
        assertTrue(vertices[0]==null && vertices[1].equals("A"));
        
        Edge<String, String> edge7 = null;
        instance.endVertices(edge7);
        assertTrue(instance.endVertices(edge7)==null);
        
        Edge<String, String> edge8=new Edge<>("DSA", 0, null, null);
        
        assertTrue(instance.endVertices(edge8)==null);
    }
    ...
    public void testOpposite() {
        ...
        Edge<String, String> edge9 = instance.getEdge("E", "E");
        assertTrue(instance.opposite("R", edge9) == null);
    }
    ...
    public void testInsertVertex() {
        ...
        assertTrue("sixth vertex should be F", (itVert.next().equals("F") == true));
    ...
    public void testRemoveVertex() {
        ...
        assertFalse(instance.removeVertex("SJK"));
    }
    ...
    public void testRemoveEdge() {
        ...
        assertFalse(instance.removeEdge(null, null));
        assertFalse(instance.removeEdge("A", "D"));
    }
    ...
    public void testEquals() {
        ...
        other.insertVertex("H");
        other.removeVertex("E");
        assertFalse("instance should not be equal to other", instance.equals(other));
    ...
    public void testToString() {
        ...
        instance.insertVertex("B");
        instance.insertVertex("C");
        instance.insertEdge("B", "C", "Edge1", 2);
        System.out.println(instance);
    ...
    public void testHashCode() {
        ...
        instance.insertEdge("B", "C", "Edge1", 2);
        int expResult = 5;
        expResult = 19 * expResult + instance.numVertices();
        expResult = 19 * expResult + instance.numEdges();
        expResult = 19 * expResult;
